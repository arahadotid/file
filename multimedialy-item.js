...
function init(){var e,n=document.querySelectorAll(".lazyloadimg");for(e=0;e<n.length;e++)n[e].innerHTML=n[e].innerHTML.replace("\x3c!--","").replace("--\x3e","")}window.onload=init;
